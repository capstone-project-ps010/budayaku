      ...
      <div class="container-fluid">
        <header>
          <div class="logo">
            <picture>
              <a href="../index.html"
                ><img src="../img/logo12.png" alt="BudayaKu"
              /></a>
            </picture>
              ...
              <ul>
                <div class="dropdown">
                  ...
                  <ul class="dropdown-menu">
                    <li>
                      <a class="dropdown-item" href="../views/pulau-jawa.html"
                        >Jawa</a
                      >
                    </li>
                    <li>
                      <a
                        class="dropdown-item"
                        href="../views/pulau-kalimantan.html"
                        >Kalimantan</a
                      >
                    </li>
                    <li>
                      <a
                        class="dropdown-item"
                        href="../views/pulau-sumatera.html"
                        >Sumatera</a
                      >
                    </li>
                    <li>
                      <a
                        class="dropdown-item"
                        href="../views/pulau-sulawesi.html"
                        >Sulawesi</a
                      >
                    </li>
                    <li>
                      <a class="dropdown-item" href="../views/pulau-papua.html"
                        >Papua</a
                      >
                    </li>
                  </ul>
